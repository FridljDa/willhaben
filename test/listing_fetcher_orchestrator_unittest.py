...
class TestListingFetcherOrchestrator(unittest.TestCase):
    ...
    @patch('listing.listing_fetcher_orchestrator.MultipleListings')
    def test_fetch_and_process_listings(self, MockMultipleListings, MockListingDetailsFetcher, MockListingsOverviewFetcher):
        # Arrange
        ...
        mock_multiple_listings = MockMultipleListings.return_value
