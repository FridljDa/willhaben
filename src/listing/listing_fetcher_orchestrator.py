...
class ListingFetcherOrchestrator:
    ...
    def fetch_and_process_listings(self):
        ListingsOverviewFetcher(self.url_query, self.multiple_listings).fetch_all_listings()
        ...
        if not self.silent:
            ...
            print(f"Number of listings: {len(self.multiple_listings.list_of_listings)}")
