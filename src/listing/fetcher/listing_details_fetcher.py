...
from listing.structure import single_listing
...
class ListingDetailsFetcher(Fetcher):
    ...
    def __init__(self, single_listing_with_url: SingleListing):
        ...
        """
        super().__init__(single_listing_with_url.listing_data['url'])  # Initialize the parent class
    ...
    def fetch_and_set_single_listing_content(self) -> None:
        ...
        """
        parsed_data = Fetcher.fetch_content_as_json(self.url)  # Use inherited method
        ...
        for listing_attribute_key_value in listing_attribute:
            self.single_listing.listing_data[listing_attribute_key_value["name"]] = listing_attribute_key_value["values"]
