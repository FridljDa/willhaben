...
dtypes_columns = {
  ...
  'BUILDING_CONDITION': 'category',  # Example: 'Neuwertig', 'Sehr gut/gut'
  'BUILDING_TYPE': 'category',  # Example: 'Altbau', 'Neubau'
  ...
  # Example: 'Hamburgerstraße', 'Schütterstr. 23-25'
  'NO_OF_ROOMS': 'float',  # Example: '1', '1.5'
  'OWNAGETYPE': 'category',  # Example: 'Miete'
  'PROPERTY_TYPE': 'category',  # Example: 'Zimmer/WG', 'Garconniere'
